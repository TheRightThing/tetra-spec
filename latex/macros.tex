...
% cn: code name
\newcommand{\fund}[0]{\mathtt{fund.}}
\newcommand{\core}[0]{\mathtt{core.}}
...
\newcommand{\retstmt}[1]{\texttt{\textbf{return}}~#1}
...
\newcommand{\ArrayType}[0]{\mathsf{ArrayType}}
\newcommand{\ElemType}[0]{\mathsf{ElemType}}
\newcommand{\DeclareStruct}[0]{\mathsf{DeclareStruct}}
\newcommand{\DeclarePrimitive}[0]{\mathsf{DeclarePrimitive}}
\newcommand{\DeclareElemType}[0]{\mathsf{DeclareElemType}}
\newcommand{\TypeID}[0]{\mathsf{TypeID}}
\newcommand{\Operation}[0]{\mathsf{Operation}}
...
\newcommand{\equivs}[3]{\left\langle\, #1, #2 \equiv #3 \,\right\rangle}
\newcommand{\forstmt}[4]{\texttt{for(}#1 \texttt{;} #2 \texttt{;} #3 \texttt{)\{} #4 \texttt{\}}}
\newcommand{\parforstmt}[2]{\texttt{for$\|$(} #1 \texttt{)\{} #2 \texttt{\}}}
\newcommand{\whilestmt}[2]{\texttt{while(} #1 \texttt{)\{} #2 \texttt{\}}}
%\opexp{op}{a0}{...}{an}
\newcommand{\opexp}[1]{\ttlparen\,\recurse{}{~}{\,\ttrparen}{#1}}
\newcommand{\ttlparen}[0]{\texttt{(}}
\newcommand{\ttrparen}[0]{\texttt{)}}
