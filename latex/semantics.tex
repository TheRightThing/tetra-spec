...
% TODO: allow \Sigma(op1, ...) to return a value.
...
$$
\Sigma(\opexp{f}{a_1}{\ldots}{a_n}) = \Sigma_n(f(v_1, \ldots, v_n)),
...
$$
\Sigma(\stmt{\retstmt{x}}{\ldots}) = \Sigma(x)
$$
$$
\Delta(\Sigma, \stmt{\retstmt{x}}{\ldots}) = \Delta(\Sigma, x)
$$